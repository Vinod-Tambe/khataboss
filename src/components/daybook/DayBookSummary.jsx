...
const DayBookSummary = ({ DayBookData,opening_data }) => {
    ...
    total_today_cash_in_amt = parseFloat(Finance_emi_deposit_data.total_cash_amt || 0) + parseFloat(Loan_deposit_data.total_cash_amt || 0) + parseFloat(Release_loan_data.total_cash_amt || 0) + parseFloat(Auction_loan_data.total_cash_amt || 0) + parseFloat(Transfer_loan_out_data.total_cash_amt || 0) + parseFloat(First_month_interest_data.total_cash_amt || 0) + parseFloat(Processing_amount_data.total_cash_amt || 0);
    total_today_bank_in_amt = parseFloat(Finance_emi_deposit_data.total_bank_amt || 0) + parseFloat(Loan_deposit_data.total_bank_amt || 0) + parseFloat(Release_loan_data.total_bank_amt || 0) + parseFloat(Auction_loan_data.total_bank_amt || 0) + parseFloat(Transfer_loan_out_data.total_bank_amt || 0) + parseFloat(First_month_interest_data.total_bank_amt || 0) + parseFloat(Processing_amount_data.total_bank_amt || 0);
    total_today_online_in_amt = parseFloat(Finance_emi_deposit_data.total_online_amt || 0) + parseFloat(Loan_deposit_data.total_online_amt || 0) + parseFloat(Release_loan_data.total_online_amt || 0) + parseFloat(Auction_loan_data.total_online_amt || 0) + parseFloat(Transfer_loan_out_data.total_online_amt || 0) + parseFloat(First_month_interest_data.total_online_amt || 0) + parseFloat(Processing_amount_data.total_online_amt || 0);
    total_today_card_in_amt = parseFloat(Finance_emi_deposit_data.total_card_amt || 0) + parseFloat(Loan_deposit_data.total_card_amt || 0) + parseFloat(Release_loan_data.total_card_amt || 0) + parseFloat(Auction_loan_data.total_card_amt || 0) + parseFloat(Transfer_loan_out_data.total_card_amt || 0) + parseFloat(First_month_interest_data.total_card_amt || 0) + parseFloat(Processing_amount_data.total_card_amt || 0);
    total_today_disc_in_amt = parseFloat(Finance_emi_deposit_data.total_disc_amt || 0) + parseFloat(Loan_deposit_data.total_disc_amt || 0) + parseFloat(Release_loan_data.total_disc_amt || 0) + parseFloat(Auction_loan_data.total_disc_amt || 0) + parseFloat(Transfer_loan_out_data.total_disc_amt || 0) + parseFloat(First_month_interest_data.total_disc_amt || 0) + parseFloat(Processing_amount_data.total_disc_amt || 0);
    total_today_in_amt = parseFloat(Finance_emi_deposit_data.total_amt || 0) + parseFloat(Loan_deposit_data.total_amt || 0) + parseFloat(Release_loan_data.total_amt || 0) + parseFloat(Auction_loan_data.total_amt || 0) + parseFloat(Transfer_loan_out_data.total_amt || 0) + parseFloat(First_month_interest_data.total_amt || 0) + parseFloat(Processing_amount_data.total_amt || 0);

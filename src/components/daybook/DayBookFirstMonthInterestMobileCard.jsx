...
import { formatCurrency, getFirstMonthInterestRowAmounts } from "./dayBookUtils";
    ...
    <div className={`daybook-mobile-row ${expanded ? "is-open" : ""}`}>
      <div className="daybook-mobile-row__main">
        ...
        <button
          ...
          aria-label={expanded ? "Hide interest details" : "Show interest details"}
        >
...
export default DayBookFirstMonthInterestMobileCard;

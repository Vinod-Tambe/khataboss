...
const AuctionModal = ({ isOpen, onClose, isTab }) => {
  ...
  const content = (
    <div className="custom-modal-body bg-red">
      ...
      <div className="row g-3 mb-2">
        ...
        <div className="col-md-3">
          <label className="form-label">Auction Charge</label>
          <input type="text" className="form-control border-dark text-center" defaultValue="2" />
        </div>
        <div className="col-md-3">
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-md-2">
          <label className="form-label">Profit/Loss Amount</label>
          <input type="text" className="form-control border-dark text-center" defaultValue="2" />
        </div>
        <div className="col-md-3">
        ...
        <div className="col-md-2">
          <label className="form-label">Final Profit/Loss</label>
          <input type="text" className="form-control border-dark text-center" defaultValue="" />
        </div>
      </div>

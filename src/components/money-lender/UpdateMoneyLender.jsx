...
import {
    ...
    documentsFromMoneyLenderImages,
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (ml) {
                    ...
                    if (ml.ml_profile_img?.path) {
                        setPhotoPreview(resolveImageUrl(ml.ml_profile_img));
                    }
                    setDocuments(documentsFromMoneyLenderImages(ml));
                    setRemovedDocPaths([]);
                }
            } catch (error) {
